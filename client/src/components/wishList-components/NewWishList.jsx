...
const NewWishList = () => {
    ...
    return (
        <>
            <div>hello this is the new wish list component. there will be a form to create a new wish list here.</div>
            <form onSubmit={submitHandler}>
                ...
                <input type="submit" value="Add New WishList" className="btn btn-primary mt-3" />
            </form>
        </>
    );
}
